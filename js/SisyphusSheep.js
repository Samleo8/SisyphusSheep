var SisyphusSheepGame = function() {
    ...
    */
    ...
    this.iconNames = ["pause", "play", "music_on", "music_off", "fx_on", "fx_off", "games", "info", "web", "logout",
        "leaderboard", "achievements", "restart", "ad", "shop", "coin", "dollar", "post", "back", "left_arrow",
        "right_arrow", "shirt", "tick", "restore", "sprint", "run"];
    ...
    */
        ...
        "showAd": function(type, reward_type, reward_amount) {
            ...
            switch (type) {
                ...
                case "rewardvideo":
                    ...
                    this.reward_amount = (reward_amount == null) ? (50 * getRandomInt(1, 5)) :
                    reward_amount;
                    break;
                case "interstitial":
                case "video":
            ...
            for (i = 0; i < buttons.length; i++) {
                ...
                if (typeof admob == "undefined" || admob == null) {
                    ...
                    text = (btn == Game.reviveButton) ? "Watch an ad to revive\nUsable once per game" :
                        "Watch ads to earn between 10-150 coins!";
                }
    ...
    this.purchases = {
        ...
        "updateButtons": function() {
            ...
            buttons.push(Game
            .restorePurchasesButton); //reason for this is to ensure that the productData index doesnt screw up
                    ...
                    switch (btn) {
                        ...
                        case Game.coinBuyButton:
                            if (this.productData == null)
                                ...
                                text = "Buy 500 coins\nfor " + this.productData[i]["currency"] + " " + this
                                .productData[i]["priceAsDecimal"];
                            break;
                        default:
                            if (this.productData != null) {
                                text = "";

                                btn.text.text = this.productData[i]["currency"] + " " + this.productData[i][
                                    "priceAsDecimal"];
    ...
    this.initPreload = function() {
        ...
        for (i = 0; i < this.powerupNames.length; i++) {
            this.loader.add("powerup_" + this.powerupNames[i].toString(), "img/powerups/" + this.powerupNames[
                i] + ".png");
        }
        ...
        this.loader.on('progress', (loader, resource) => {
            ...
            this.loadingBar.progressBar.beginFill(0xcfd8dc)
                .drawRect(-this.loadingBar.progressBar.maxWidth / 2, 0, _width, this.loadingBar
                    .progressBar.maxHeight)
                .endFill();
        ...
        this.loader.load((loader, resources) => {
            ...
            this.powerupOffset = this.sprites.rock.height / 100 + this.sprites.powerups[this
                .powerupNames[0]].height * (0.3) + 50;
            ...
            this.pauseButton.getChildByName("pause")
                .alpha = 1;
            ...
            this.muteMusicButton.on((_isMobile) ? "touchend" : "mouseup", this.toggleMuteMain.bind(
                this));
            ...
            this.muteMusicButton.getChildByName("music_on")
                .alpha = 1;
            ...
            this.muteFXButton.getChildByName("fx_on")
                .alpha = 1;
            ...
            this.gamesButton.on((_isMobile) ? "touchend" : "mouseup", this.showPlayGamesMenu.bind(
            this));

            this.gamesButton.position.set(80, 50);

            this.gamesButton.addChild(this.sprites.icons["games"]);
            this.gamesButton.getChildByName("games")
                .alpha = 1;
            ...
            this.infoButton.getChildByName("info")
                .alpha = 1;
            ...
            this.webButton.on((_isMobile) ? "touchend" : "mouseup", this.gotoURL.bind(this,
                "https://samleo8.github.io/games/"));

            this.webButton.position.set(292, 50);

            this.webButton.addChild(this.sprites.icons["web"]);
            this.webButton.getChildByName("web")
                .alpha = 1;
            ...
            this.shopButton.getChildByName("shop")
                .alpha = 1;
    ...
    this.loadFonts = function() {
        ...
        this.totalFonts = Object.keys(this.fonts)
            .length;
        this.totalFontsLoaded = 0;
        this.totalFontsFailed = 0;
    ...
    this.buildStartScreen = function() {
        ...
        rect.lineStyle(8, 0x90a4ae)
            .moveTo(0, this.canvasHeight / 2 - 150)
            .lineTo(500, this.canvasHeight / 2 - 150)
            .moveTo(0, this.canvasHeight / 2 - 10)
            .lineTo(500, this.canvasHeight / 2 - 10)
            .moveTo(1100, this.canvasHeight / 2 - 150)
            .lineTo(1600, this.canvasHeight / 2 - 150)
            .moveTo(1100, this.canvasHeight / 2 - 10)
            .lineTo(1600, this.canvasHeight / 2 - 10);
        ...
        var text = new PIXI.Text("SISYPHUS", Object.assign(textOpt, {
            fontSize: 110
        }));
        text.anchor.set(0.5, 0.5);
        ...
        this.loadingBar.progressText.y = this.loadingBar.progressBar.maxHeight / 2 + this.loadingBar.progressBar
            .strokeWidth / 2;
    ...
    this.generateOverlays = function() {
        ...
        var text = new PIXI.Text("PAUSED", Object.assign(textOpt, {
            fontSize: 120
        }));
        text.anchor.set(0.5, 0.5);
        text.alpha = 0.75;
        ...
        var text = new PIXI.Text("INFO", Object.assign(textOpt, {
            fontSize: 75
        }));
        text.anchor.set(0.5, 0.5);
        text.alpha = 0.98;
        ...
        var text2 = new PIXI.Text(
            ...
            ((isApp()) ?
                "The web version is available on my website at\n https://samleo8.github.io/SisyphusSheep" :
                "The mobile app is available on the Google Play Store under the name \'Sisyphus Sheep\'"),
            textOpt2
        );
        ...
        var textOpt3 = Object.assign(textOpt, {
            strokeThickness: 7,
            fontSize: 45
        });
        ...
        text2 = new PIXI.Text(
            "[Miqz] http://www.newgrounds.com/audio/listen/719242\nhttp://www.noiseforfun.com/", textOpt2);
        text2.anchor.set(0.5, 0);
        text2.alpha = 0.98;
        text2.x = this.canvasWidth / 2;
        ...
        var buttonHeight = 105,
            buttonWidth = 335,
            padd = 100;
        var pseudoPaddX = 80,
            pseudoPaddY = 120; //for making the hitbox bigger
        var iconPos = 75;
        textOpt2 = {
            fontFamily: 'TimeBurner',
            fill: "#cfd8dc",
        ...
        this.shareButton.position.set(this.canvasWidth / 2 + 280, (this.gameoverScreen.scoreText.y + this
            .gameoverScreen.highscoreText.y) / 2 - 20);
        ...
        this.shareButton.icon = this.sprites.icons[
        "post"]; //weird bug where icons with names share and social are prevented from loading. possibly by adblocker
        ...
        //Title
        text = new PIXI.Text("STORE", Object.assign(textOpt, {
            fontSize: 60
        }));
        ...
        */
        ...
        this.shop.coin_text = new PIXI.Text(this.coins, Object.assign(textOpt2, {
            fontSize: 40
        }));
        ...
        //Title
        text = new PIXI.Text("PLAY GAMES", Object.assign(textOpt, {
            fontSize: 60
        }));
        text.anchor.set(0.5, 0);
        text.alpha = 0.98;
        ...
        profile.player_text = new PIXI.Text("PLAYER", Object.assign(textOpt2, {
            fontSize: 48
        }));
    ...
    this.allAssetsLoaded = function() {
        ...
        bubble.beginFill(0xcfd8dc)
            .drawRoundedRect(-bubble._width / 2, -bubble._height / 2, bubble._width, bubble._height, bubble
                ._radius)
            .drawPolygon(new PIXI.Point(-bubble._width / 2 + 255, -bubble._height / 2 - 45), new PIXI.Point(-
                125, -bubble._height / 2), new PIXI.Point(-95, -bubble._height / 2))
            .endFill();
        ...
        //Fade In Animation
        this.fadeObjects = [sheep, speech_bubble, this.infoOverlay, this.playGamesMenu, this.shop, this
            .muteMusicButton, this.muteFXButton, this.infoButton, this.gamesButton, this.webButton, this
            .shopButton, this.backButton];
    ...
    this.startGame = function() {
        ...
        //-Score text
        this.scoreText = new PIXI.Text(this.score.toString(), Object.assign(textOpt, {
            fontSize: 120
        }));
        ...
        //-Highscore text
        this.highscoreText = new PIXI.Text(this.highscore.toString(), Object.assign(textOpt, {
            fontSize: 40
        }));
        ...
        //-"/"-symbol
        this.overSym = new PIXI.Text("/", Object.assign(textOpt, {
            fontSize: 50
        }));
        ...
        this.treadmill.flag.y = this.canvasHeight - this.treadmill.flag.height / 2 - this.treadmill.gears
        .height;
        ...
        this.playButtons.y = this.canvasHeight - this.playButtons.styles.bottomMargin - this.playButtons.styles
            .width / 2;
        ...
        for (i in this.playButtons.childButtons) {
            ...
            playButton.x = this.playButtons.styles.sideMargin + this.playButtons.styles.width / 2 + cnt * (this
                .playButtons.styles.sideMargin + this.playButtons.styles.width);
            playButton.y = 0;
            ...
            if (nm == "sprint") {
                playButton.x = this.canvasWidth - (this.playButtons.styles.sideMargin + this.playButtons.styles
                    .width / 2);
                ...
                this.sprint.circle.bar.lineStyle(this.sprint.circle.thickness, 0xef6c00)
                    .arc(0, 0, (this.playButtons.styles.width + this.sprint.circle.thickness) / 2, -Math.PI / 2,
                        -Math.PI / 2 + (this.sprint.level / 50) * Math.PI);
            ...
            playButton.on((_isMobile) ? "touchendoutside" : "mouseupoutside", this.playButtonHandler.bind(this,
                nm));
    ...
    this.nextLevel = function() {
        ...
        this.hero.x = Math.max(this.heroStartX.min - this.heroStartX.inc * this.portalsPassed, this.heroStartX
            .max);
    ...
    this.update = function() {
        ...
        if (this.hero.sprinting) {
            if (this.sprint.level > 0) {
                ...
                //Achievement
                if (!this.achievements.single.sprint_spent[0].complete || !this.achievements.single
                    .sprint_spent[0].synced) {
        ...
        this.sprint.circle.bar.lineStyle(this.sprint.circle.thickness, 0xef6c00)
            .arc(0, 0, (this.playButtons.styles.width + this.sprint.circle.thickness) / 2, -Math.PI / 2, -Math
                .PI / 2 + (this.sprint.level / 50) * Math.PI);
        ...
        if (this.obstaclesFrozen && t - this.obstaclesTimer >= this.obstaclesFreezeTime + this.pauseTime[
                "freeze"]) {
    ...
    this.setObstaclePosition = function(obj) {
        ...
        var startX = _dir * getRandomFloat(0, _range) + this.hero
        .x; //make it such that it's near to the player positon (muhaha)
        startX = Math.min(this.canvasWidth - obj.width / 2, Math.max(obj.width / 2,
        startX)); //ensure still within range
    ...
    this.collectPowerup = function(type_name) {
        ...
        */
        ...
        //ACHIEVEMENT:
        //-Single:
        if (!this.achievements.single.shield_once[0].complete || !this.achievements.single.shield_once[0]
            .synced) {
            this.GooglePlayServices.unlockAchievement("shield_once");
        }
        //-Incremental:
        for (i = 0; i < this.achievements.incremental.shield.length; i++) {
            if (!this.achievements.incremental.shield[i].complete || !this.achievements.incremental.shield[i]
                .synced) {
    ...
    this.prepareShopContent = function() {
        ...
        /* UPGRADES */
        var totalUpgrades = Object.keys(this.upgrades)
            .length;

        var buttonHeight = 75,
            buttonWidth = 280;
        var pseudoPaddX = 15,
            pseudoPaddY = 55; //for making the button hitbox bigger
        var iconPos = 65;
        ...
        for (i in this.upgrades) {
            ...
            this.upgradesSection[nm].button.position.set(width / 2 - buttonWidth / 2, height - buttonHeight -
                62);
            ...
            this.upgradesSection[nm].button.pseudoBg.beginFill(0x263238, 0)
                .drawRect(-pseudoPaddX, -pseudoPaddY, buttonWidth + 2 * pseudoPaddX, buttonHeight + 2 *
                    pseudoPaddY)
                .endFill();

            this.upgradesSection[nm].button.text = new PIXI.Text(data["cost"] * (data["increment_count"] + 1),
                textOpt);
            this.upgradesSection[nm].button.text.anchor.set(0.5, 0.5);
            this.upgradesSection[nm].button.text.position.set(buttonWidth / 2 + iconPos / 2 - 15, buttonHeight /
                2);

            this.upgradesSection[nm].button.interactive = true;
            this.upgradesSection[nm].button.buttonMode = true;
            this.upgradesSection[nm].button.on((_isMobile) ? "touchend" : "mouseup", this.performUpgrade.bind(
                this, nm));
        ...
        var totalAccessories = Object.keys(this.accessories)
            .length;
        ...
        this.shop.navArrows.right.on((_isMobile) ? "touchend" : "mouseup", this.skinPagesNav.bind(this,
        "next"));
        ...
        for (j = 0; j < this.accessoriesNames.length; j++) {
            ...
            this.skinsSection[nm].position.set(navArrowWidth + width * (cnt % 4),
            0); //((cnt%8)<4)?-5:(contentHeight/2-27));
            ...
            this.skinsSection[nm].button.icon = new PIXI.Sprite(this.sprites.icons[data["currency"].toString()]
                .texture);
            ...
            this.skinsSection[nm].button.text.position.set(buttonWidth / 2 + iconPos / 2 - 15, buttonHeight /
            2);

            this.skinsSection[nm].button.interactive = true;
            this.skinsSection[nm].button.buttonMode = true;
            this.skinsSection[nm].button.on((_isMobile) ? "touchend" : "mouseup", this.setAccessory.bind(this,
                nm, data["type"]));
        ...
        this.coinAdButton.on((_isMobile) ? "touchend" : "mouseup", this.ads.showAd.bind(this.ads, "rewardvideo",
            "coins", 10 * getRandomInt(1, 15)));
        ...
        this.coinBuyButton.on((_isMobile) ? "touchend" : "mouseup", this.purchases.buy.bind(this.purchases,
            "coins500"));
        ...
        this.restorePurchasesButton.on((_isMobile) ? "touchend" : "mouseup", this.purchases.restore.bind(this
            .purchases));
        ...
        textOpt4 = Object.assign(textOpt4, {
    ...
    this.performUpgrade = function(nm, e) {
        ...
        //ACHIEVEMENT:
        //-Single (Enhanced):
        if (!this.achievements.single.enhanced_once[0].complete || !this.achievements.single.enhanced_once[0]
            .synced) {
            this.GooglePlayServices.unlockAchievement("enhanced_once");
        }
        //-Incremental:
        for (i = 0; i < this.achievements.incremental.enhanced.length; i++) {
            if (!this.achievements.incremental.enhanced[i].complete || !this.achievements.incremental.enhanced[
                    i].synced) {
    ...
    this.updateUpgradesPage = function() {
        ...
        for (i in this.upgrades) {
            ...
            switch (data["type"]) {
                case "one-off":
                    footnoteText = (data["increment_count"] == data["max_increments"]) ? "Activated" :
                        "Activate";
                    break;
                case "value":
        ...
        for (i in this.upgrades) {
            ...
            if (data["increment_count"] >= data["max_increments"]) {
                ...
                if (this.achievements.single.max_upgrade != null) {
                    if (!this.achievements.single.max_upgrade[0].complete || !this.achievements.single
                        .max_upgrade[0].synced) {
        ...
        switch (type) {
            ...
            case "body":
                if (this.hero.sheep == null || typeof this.hero.sheep == "undefined") {
                    ...
                    this.hero.sheep = new PIXI.AnimatedSprite(this.animations[((accessory == "little_lamb" ||
                        accessory == "sheep_running") ? "sheep_base" : accessory)].frames);
                    this.hero.sheep.animationSpeed = 0.15;
                    ...
                    this.hero.sheep.texture = this.animations[((accessory == "little_lamb" || accessory ==
                        "sheep_running") ? "sheep_base" : accessory)];
            ...
            case "cape":
                if (this.hero.cape == null || typeof this.hero.cape == "undefined") {
                    this.hero.cape = new PIXI.Sprite(((accessory == "no_cape") ? PIXI.Texture.EMPTY : this
                        .sprites.capes[accessory].texture));
            ...
            case "headdress":
                if (this.hero.hat == null || typeof this.hero.hat == "undefined") {
                    this.hero.hat = new PIXI.Sprite(((accessory == "no_hat") ? PIXI.Texture.EMPTY : this.sprites
                        .hats[accessory].texture));
    ...
    this.setAccessoriesPositions = function(dir) {
        ...
        if (this.hero.hat) {
            ...
            this.hero.hat.x = dir * (this.hero.sheep.width / 2 + this.hero.sheep.width * this.hero.hat
                .displacement);
        ...
        if (this.hero.cape) {
            ...
            this.hero.cape.x = dir * (this.hero.sheep.width / 2 + this.hero.sheep.width * this.hero.cape
                .displacement);
    ...
    this.skinPagesNav = function(page) {
        ...
        this.shop.navArrows.pageIndicator.text = "PAGE\n" + (this.skinsPages.currPage + 1) + " / " + this
            .skinsPages.totalPages;
        ...
        window.plugins.playGamesServices.auth(function() {
            ...
            for (i in this.achievements.single) {
                ...
                for (j = 0; j < this.achievements.single[i].length; j++) {
                    if (this.achievements.single[i][j].complete && !this.achievements.single[i][j]
                        .synced) {
            ...
            for (i in this.achievements.incremental) {
                ...
                for (j = 0; j < this.achievements.incremental[i].length; j++) {
                    unsyncedSteps = parseInt(this.achievements.incremental[i][j].completedSteps) -
                        parseInt(this.achievements.incremental[i][j].completedSteps_synced);
                    if (unsyncedSteps > 0) {
                        this.GooglePlayServices.incrementAchievement(i.toString(), j, unsyncedSteps,
                            true);
                    }
                }
            }
    ...
    this.showPlayGamesMenu = function(e) {
        ...
        if (!this.playGamesMenu.visible) {
            ...
            if (typeof window.plugins == "undefined") {
                ...
                if (confirm(
                        "Google Play Games is only supported in the Mobile App! Click 'OK' to be redirected to the Google Play Store. Cancel otherwise."
                        )) {
    ...
    this.toggleMuteMain = function(forcedVal) {
        ...
        if (this._musicMuted) {
            this.muteMusicButton.getChildByName("music_off")
                .alpha = 0;
            this.muteMusicButton.getChildByName("music_on")
                .alpha = 1;
            renderer.render(stage);
    ...
    this.toggleMuteFX = function(forcedVal) {
        ...
        if (this._FXMuted) {
            this.muteFXButton.getChildByName("fx_off")
                .alpha = 0;
            this.muteFXButton.getChildByName("fx_on")
                .alpha = 1;
            renderer.render(stage);
            ...
            for (i = 0; i < this.audioLib.length; i++) {
                nm = this.audioLib[i];
                if (nm == "main_music" || this.audio[nm] == null || typeof this.audio[nm] == "undefined")
                    continue;
    ...
    this.togglePause = function(forcedVal, event) {
        ...
        if (this._paused) {
            ...
            this.pauseButton.getChildByName("pause")
                .alpha = 1;
            this.pauseButton.getChildByName("play")
                .alpha = 0;

            for (i in this.pauseTime) {
                if (!this.pauseTime.hasOwnProperty(i)) continue;

                this.pauseTime[i] += (new Date()
                    .getTime()) - this.pauseTimer;
            }
            this._paused = false;
    ...
    this.gameover = function() {
        ...
        if (this.hero.x >= this.hero.sheep.width / 2 - this.hero.leeway) {
            if ((this.noDeathChance || this.hero.cape.name == "royal_cape") && Math.random() < (this
                    .noDeathChance + this.whiteCapeBonus)) {
                //Just continue game
                requestAnimationFrame(this.update.bind(this));
        ...
        for (i = 0; i < this.achievements.incremental.die.length; i++) {
            if (!this.achievements.incremental.die[i].complete || !this.achievements.incremental.die[i]
                .synced) {
    ...
    this.share_social = function() {
        var options = {
            message: 'Can you beat my score of ' + this.score +
            ' on Sisyphus Sheep?', // not supported on some apps (Facebook, Instagram)
        ...
        if (typeof window.plugins != "undefined" && window.plugins != null) {
            ...
            if (confirm(
                    "For now, you can only share your scores on the Android app. Click 'OK' to download it now!"
                    )) {
                this.gotoURL("https://play.google.com/store/apps/details?id=io.samleo8.SisyphusSheep");
            }
    ...
    this.loadOptions = function() {
        ...
        if (window.localStorage) {
            ...
            if (!window.localStorage.getItem("coins_reward1") || !parseBoolean(window.localStorage[
                    "coins_reward1"])) {
            ...
            console.log(
                "WARNING: Browser does not support localStorage! Highscores, achievements and options will not be saved."
                );
            return false;
        }
    };
    ...
    this.GooglePlayServices = {
        ...
        "sendScore": function(score, leaderboardID) {
            ...
            window.plugins.playGamesServices.submitScoreNow(data, function() {
                console.log("Score of " + data.score + " submitted to Google Play leaderboard  " +
                    data.leaderboardId + "!");
            }.bind(Game), function() {
                console.log("Failure to submit score of " + data.score + " to Google Play" + ((Game
                    .isOnline) ? "!" : ": Check your connection and try again!"));
            });
        },
        ...
        "incrementAchievement": function(achievementName, num, steps, syncing) {
            ...
            if (!syncing) {
                achData["completedSteps"] = Math.min(achData["completedSteps"] + steps, achData[
                    "totalSteps"]);
            ...
            window.plugins.playGamesServices.incrementAchievement(data, function() {
                console.log("Achievement " + achData["name"] + " incremented by " + steps +
                    " steps");
                achData["completedSteps_synced"] = Math.min(achData["completedSteps_synced"] +
                    steps, achData["totalSteps"]);
    ...
    this.hitTest = function(obj1, obj2, leewayX, leewayY, setAnchor) {
        ...
        if (Math.abs(obj1.x - obj2.x) <= (obj1.width + obj2.width - leewayX) / 2 && Math.abs(obj1.y - obj2.y) <=
            (obj1.height + obj2.height - leewayY) / 2) {
